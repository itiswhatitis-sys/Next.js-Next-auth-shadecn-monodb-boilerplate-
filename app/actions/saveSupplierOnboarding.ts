// app/actions/saveSupplierCompany.ts
'use server';
...
const companySchema = z.object({
  ...
  teamMembers: z
    ...
    .optional(),
  teamSkipped: z.boolean().optional(), // ✅ Add this field
});

type formSchema = z.infer<typeof companySchema>

// ----- Server Action -----
export async function saveSupplierCompany(data: formSchema) {
  try {
    // Connect to MongoDB
    await connect();
    ...
    // Create & save company
    const company = await SupplierCompany.create(dataToSave);
