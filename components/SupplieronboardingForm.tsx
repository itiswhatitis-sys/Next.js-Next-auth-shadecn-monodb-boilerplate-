...
import { saveSupplierCompany } from "@/app/actions/saveSupplierOnboarding"
// ---------------- Validation Schemas ----------------
  ...
  teamMembers: z
    .array(
      z.object({
        ...
        role: z.enum(["operations", "quality", "finance"]),
      })
    )
    .optional(),
})
...
// ---------------- Component ----------------
export default function SupplierOnboardFlow() {
...
const onSkipTeam = async () => {
  try {
    ...
    const result = await saveSupplierCompany(dataWithSkip);
...
const onSubmit = async (values: FormValues) => {
  try {
    ...
    const result = await saveSupplierCompany(dataWithSkipFlag);
                            ...
                            <FormControl>
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="quality">Quality Assesment</SelectItem>
